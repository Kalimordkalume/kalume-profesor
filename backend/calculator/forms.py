...
class CreateEnergyForm(forms.Form):
    planets = forms.IntegerField(
        ...
        widget=forms.NumberInput(
            attrs={"class": "form-control", "placeholder": "Planet Count"}
        ),
    )
    fusion = forms.IntegerField(
        ...
        label="Fusion Level",
        widget=forms.NumberInput(
            attrs={"class": "form-control", "placeholder": "Fusion Level"}
        ),
    )
    energy = forms.IntegerField(
        ...
        label="Energy Level",
        widget=forms.NumberInput(
            attrs={"class": "form-control", "placeholder": "Energy Level"}
        ),
    )
    ...
    life_form_level = forms.IntegerField(
        ...
        widget=forms.NumberInput(
            attrs={"class": "form-control", "placeholder": "Life Form Level"}
        ),
    )
    steps = forms.IntegerField(
        ...
        label="Desired Steps",
        widget=forms.NumberInput(
            attrs={"class": "form-control", "placeholder": "Desired Steps"}
        ),
    )
